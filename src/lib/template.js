...
const HEADERS = ['CURS', 'INFANT', 'TITULAR', 'IBAN', 'DNI', 'REFERÈNCIA MANDAT', 'DATA SIGNATURA MANDAT']

const EXAMPLE_ROWS = [
  ['I3', 'Marina Puig Soler', 'Anna Soler Vila', 'ES00 0000 0000 0000 0000 0000', '12345678A', 'FAM001', '2026-09-01'],
  ['I5', 'Pol Puig Soler', '', '', '', '', ''],
  ['P3', 'Martí Riera Costa', 'Martí Riera Costa', 'ES00 1111 1111 1111 1111 1111', '23456789B', 'FAM002', '2026-09-03'],
]

const INSTRUCTIONS = [
  ['Com omplir aquest Excel'],
  [''],
  ['El full "SEPA" ha de tenir les columnes CURS, INFANT, TITULAR, IBAN, DNI, REFERÈNCIA MANDAT i DATA SIGNATURA MANDAT (en qualsevol ordre).'],
  [''],
  ...
  [''],
  ['La DATA SIGNATURA MANDAT és la data en què la família va signar l’autorització de càrrec (formats admesos: AAAA-MM-DD o DD/MM/AAAA). És opcional: si es deixa en blanc, l’aplicació proposa una data per defecte que es pot revisar fila a fila.'],
...
export function downloadTemplate() {
  ...
  sepaSheet['!cols'] = [{ wch: 8 }, { wch: 28 }, { wch: 28 }, { wch: 30 }, { wch: 12 }, { wch: 16 }, { wch: 20 }]
